...
//확인사항: var는 엄격하지 않고, let은 문법에 엄격하다.
console.log('오류 후 실행이 안 됨');//오류 발생 시 다음으로 코드가 넘어가지 않음

const e="한 번 값 선언 후 값 변경 불가";
console.log(e);
// e="값을 변경함" //값 변경 시 오류 발생

'use strict'
//클래스 : 속성+함수(생성자 함수=클래스명()=constructor())
class Person{
    //java
    //String name;
    //int age;
    constructor(name,age){
        this.name=name; //this는 이 객체에서 name은 멤버변수
        this.age=age;
    }
...
// console.log(newp.name());//함수로서 호출은 오류 발생
newp._name="park2";//변수에 값을 직접 설정
console.log(newp._name);
newp._name="park3";//set함수 호출
console.log(newp.name);

//XMLHttpRequest : 비동기식
//fetch() //동기식(순서에 맞게끔 처리)